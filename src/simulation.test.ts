...
describe('simulateScenario', () => {
  it('should map matched RCP deny statement IDs from rcp analysis', async () => {
    ...
    //Then the denied row should include the matched RCP statement ID
    expect(result).toEqual({
      resultType: 'success',
      rowResult: {
        resultType: 'explicitlyDenied',
        label: 'Denied',
        matchedStatementIds: ['DenyObjectRead']
      },
      diagnostics: []
    })
  })
